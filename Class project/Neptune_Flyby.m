...
JupiterToDSM_TOF_TU=800 / solarTU_days; % Jupiter flyby -> DSM
...
neptuneParkingOrbitAlt_km= 2000
...
[earthAfterLeg1_r, earthAfterLeg1_v, marsAfterLeg1_r, marsAfterLeg1_v, ...
    jupiterAfterLeg1_r, jupiterAfterLeg1_v, scAfterLeg1_r, scAfterLeg1_v] = ...
    planet_plotearthsmall(earthDepart_r, earthDepart_v, marsDepart_r, ...
    marsDepart_v, Jupiter_departure_r, Jupiter_departure_v, ...
...
[earthAfterDSM_r, earthAfterDSM_v, marsAfterDSM_r, marsAfterDSM_v, ...
    jupiterAfterDSM_r, jupiterAfterDSM_v, scAfterDSM_r, scAfterDSM_v] = ...
    planet_plotmarssmall(earthAfterLeg1_r, earthAfterLeg1_v, marsAfterLeg1_r, ...
    marsAfterLeg1_v, jupiterAfterLeg1_r, jupiterAfterLeg1_v, ...
...
[earthAfterFlybyPlot_r, earthAfterFlybyPlot_v, marsAfterFlybyPlot_r, ...
    marsAfterFlybyPlot_v, jupiterAfterFlybyPlot_r, jupiterAfterFlybyPlot_v, ...
    scBeforeEarthFlyby_r, scBeforeEarthFlyby_v] = ...
    planet_plotmarssmall(earthAfterDSM_r, earthAfterDSM_v, marsAfterDSM_r, ...
    marsAfterDSM_v, jupiterAfterDSM_r, jupiterAfterDSM_v, plotStart_TU, ...
...
% Plot Earth, Mars, Jupiter, and an optional spacecraft over one time span.
    ...
    makeThreeBodyPlot(Earth_r, Mars_r, Jupiter_r, Earth_orbit_r, Mars_orbit_r, ...
        Jupiter_orbit_r, SC_orbit_r, Spacecraft_r, 1);
...
% Same plotting helper as above, but allows caller to choose figure number.
    ...
    makeFourBodyPlot(Earth_r, Mars_r, Jupiter_r, Earth_orbit_r, Mars_orbit_r, ...
...
function makeFourBodyPlot(Earth_r, Mars_r, Jupiter_r, Earth_orbit_r, Mars_orbit_r, ...
    Jupiter_orbit_r, Neptune_orbit_r, SC_orbit_r, Spacecraft_r, figNumber)
